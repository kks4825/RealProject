...
<script type="text/javascript">
	...
	function idCheck() {
		...
		if (memId == "")
			...
			window.open("/TravelAgency/idCheck.do?memId=" + memId, "",
	...
	function checkEmail() {
		...
		var sEmail = $('#memEmail').val();

		if (sEmail == "")
			alert("먼저 이메일을 입력하세요");
		else
			window.open(
					"/TravelAgency/sendMail/emailChk.do?memEmail=" + sEmail,
					"", "width=320 height=100");
				...
				<form class="memberJoin" id="memberJoin" name="memberJoin"
					...
					<div class="sub_join">
						...
						<table class="board_css">
							...
							<tr>
								<th>생년월일</th>
								<td><input type="text" name="memBirth01" id="memBirth01"
									size="4" maxlength="4"> 년 <input type="text"
									name="memBirth02" id="memBirth02" size="3" maxlength="2">
									월 <input type="text" name="memBirth03" id="memBirth03" size="3"
									maxlength="2"> 일</td>
							</tr>
							<tr>
								<th>이메일</th>
								<td><input type="text" name="memEmail" id="memEmail"
									size="28"> &nbsp;<input type="button" name="mailCheck"
									id="mailCheck" value="이메일 인증"
									style="border: none; width: 85pt; height: 18pt; background-color: #404040; color: #FFFFFF;"
									onclick="checkEmail()"> <input type="hidden"
									name="mailReCheck" id="mailReCheck" value="인증완료"></td>
							</tr>
							<tr>
								<th>우편번호</th>
								<td>
									<input type="text" name="memZipCode" id="zip" size="7" readonly> 
									<input type="button" value="우편번호검색" style="border: none; width: 85pt; height: 18pt; 
									background-color: #404040; color: #FFFFFF;"	onclick="javascript:zipcodeSearch()">
								</td>
							</tr>
							<tr>
								<th>주소</th>
								<td>
									<input type="text" name="memAddr1" id="address1" size="80" readonly><br>
									<input type="text" name="memAddr2" id="address2" size="40"><br>
									<label for="memAddr2" class="error"></label>
								</td>
							</tr>
							<tr>
								<th>전화번호</th>
						...
						<div class="btn_center">
							<td colspan="3">
								<input type="submit" style="border: none; font-size: 15px; font-weight: bold; 
									   width: 70pt; height: 30pt; background-color: #1e70dd; color: #FFFFFF;" value="확인">&nbsp;&nbsp; 
								<input type="reset"	onclick="history.back();" style="border: none; 
									   font-size: 15px; font-weight: bold; border: 1px solid #d3d3d3; width: 70pt; 
									   height: 30pt; background-color: #fff; color: #404040;" value="취소">
							</td>
						</div>
						<!--btn_center-->
					</div>
