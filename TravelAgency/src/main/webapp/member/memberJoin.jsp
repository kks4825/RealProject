...
<div style="margin: 0 auto; margin-top: -80px; width: 60%;">
	...
	<br> <font color="red">&nbsp;&nbsp;*</font> <font id="s">&nbsp;표시
		항목은 필수 입력 항목입니다.</font> <br> <br>

	<table style="border-style: solid; border-color: #0100FF;">
		<tr>
			<td align="center" width="100px" bgcolor="#D4F4FA"
				style="vertical-align: middle; font-weight: bold">아 이 디</td>
		...
		<tr height="30">
			...
			<td></td>
			<td style="font-weight: bold"><input type="radio"
				name="memEmailYes" value="mailYes" checked>&nbsp;수신동의&nbsp;
				<input type="radio" name="memEmailNo" value="mailNo">&nbsp;수신거부</td>
			<!-- 이메일 검사 -->
		</tr>
		...
		<tr height="30">
			...
			<td><input type="text" name="memZipCode01" size="4"
				...
				size="4" maxlength="3">&nbsp; <input type="button"
				value="검색"
		...
		<tr>
			<td style="vertical-align: middle;" align="center" bgcolor="#D4F4FA"
				style="font-weight: bold">주 소</td>
			<td valign="top">&nbsp;&nbsp;<font color="red">*</font></td>
		...
		<tr align="center">
			<td colspan="3">
				<input type="button" style="border: none; width: 40pt; height: 20pt; 
				background-color: #36589C; color: #FFFFFF;"	value="등록" 
				onclick="location.href='/TravelAgency/joinConfirm.do'">&nbsp;&nbsp;
				<input type="reset"	style="border: none; width: 40pt; height: 20pt; 
				background-color: #36589C; color: #FFFFFF;"	value="취소">
			</td>
		</tr>
	</table>
</div>
