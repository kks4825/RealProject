...
<html>
	<head>
		...
		<noscript>
			<link rel="stylesheet" href="../css/main/css/skel-noscript.css" >
			<link rel="stylesheet" href="../css/main/css/style.css" >
			<link rel="stylesheet" href="../css/main/css/style-desktop.css" >
		</noscript>
	...
	<!-- Header -->
		...
		<div id="main">
			<div id="content" class="container">
				<div class="row">
					<section class="6u">
						<a href="#" class="image full"><img src="../image/main/pic01.jpg" alt=""></a>
						<header>
					...
					<section class="6u">
						<a href="#" class="image full"><img src="../image/main/pic02.jpg" alt=""></a>
						<header>
							<h2>Mauris vulputate dolor</h2>
						</header>
						<p>In posuere eleifend odio. Quisque semper augue mattis wisi. Maecenas ligula. Pellentesque viverra vulputate enim. Aliquam erat volutpat. Donec leo, vivamus fermentum nibh in augue praesent a lacus at urna congue rutrum.</p>
				...
				<div class="row">
					<section class="6u">
						<a href="#" class="image full"><img src="../image/main/pic03.jpg" alt=""></a>
						<header>
							<h2>Mauris vulputate dolor</h2>
						</header>
						<p>In posuere eleifend odio. Quisque semper augue mattis wisi. Maecenas ligula. Pellentesque viverra vulputate enim. Aliquam erat volutpat. Donec leo, vivamus fermentum nibh in augue praesent a lacus at urna congue rutrum.</p>
					...
					<section class="6u">
						<a href="#" class="image full"><img src="../image/main/pic04.jpg" alt=""></a>
						<header>
							<h2>Mauris vulputate dolor</h2>
						</header>
						<p>In posuere eleifend odio. Quisque semper augue mattis wisi. Maecenas ligula. Pellentesque viverra vulputate enim. Aliquam erat volutpat. Donec leo, vivamus fermentum nibh in augue praesent a lacus at urna congue rutrum.</p>
