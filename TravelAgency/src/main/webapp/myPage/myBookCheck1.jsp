...
.tcb1{background-color:none;width:996px; height:189px; padding-top:10px; layout:fixed; margin-bottom:20px;}

.tcb1a{width:946px; height:130px; padding-top:0px; layout:fixed; border:1px solid gray; text-align:justify;layout:fixed;position:relative; left : 23px; top:15px;}
...
<div class="tbc">
<div class="tcb1">예약확인 <div class="tcb1a">
<pre>
  [안내]
...
<div class="tcb3">예약 내역
<table>
<tr><td colspan="7" bgcolor="#607d8b"></td></tr>
<tr>
	
	<!-- <th width="100"><input type="checkbox" id="checkall" onclick="allCheck(this)">글번호</th> -->
	<th width="130">예약날짜/<br>예약코드/결제</th>
	<th width="300">상품명</th>
...
<div class="tcb5">취소 내역
<table>
<tr><td colspan="6" bgcolor="#607d8b"></td></tr>
<tr>
	
	<!-- <th width="100"><input type="checkbox" id="checkall" onclick="allCheck(this)">글번호</th> -->
	<th width="145">예약날짜/<br>예약코드</th>
	<th width="315">상품명</th>
