...
<form name="myPageForm" method="post"
	action="/TravelAgency/reserveSearch.do">
	<div id="body">
		<div class="t-wrap">
			<div class="tu">
				...
				<div class="tbc">
					<div class="tcb1">
						<font size=5 color=blue style="line-height: 50px;">&nbsp;
							&nbsp; <b>예약 확인</b>
						</font>
   ...
   4.  글로벌항공사이트 예약은 http://globalflight.hanatour.com my booking 에서 확인하실 수 있습니다.
						...
						<div class="tcb2">
							<div class="tcb2a">
								<table>
									<tr>
										<td width="944px" height="47px"><font color=blue size=4>
												도시검색 </font> <br> <br> <input type="text"
											...
											maxlength="255" /> <input type="button" id="SearchButton"
											style="height: 28px; width: 100px; background-color: #1e70dd; color: #FFFFFF;"
											value="&nbsp;&nbsp;search&nbsp;&nbsp;"></td>
									</tr>
								</table>
							</div>
						...
						<div class="tcb3">
							<font
								style="font-size: 15pt; line-height: 60px; background-color: #777777; color: #FFFFFF;"><b>&nbsp;&nbsp;&nbsp;&nbsp;예약
									내역</b></font>
							<table class="tcb6"
								style="font-size: 10pt; background-color: #777777; color: #FFFFFF;">
								<tr>
									<td colspan="8" bgcolor="#FFFFFF" style="height: 2px;"></td>
								</tr>
								<tr>
									<td width="300" valign="middle"
										style="text-align: center; vertical-align: middle;">상품명</td>
									<td width="130" valign="middle"
										style="text-align: center; vertical-align: middle;">출발일/귀국일</td>
									<td width="130" valign="middle" height="40"
										style="text-align: center; vertical-align: middle;">예약시간/예약번호</td>
									<td width="130" valign="middle"
										style="text-align: center; vertical-align: middle;">총
										결제금액</td>
									<td width="100"
										style="text-align: center; vertical-align: middle;">인원</td>
									<td width="130"
										style="text-align: center; vertical-align: middle;">결제상태</td>
									<td width="100"
										style="text-align: center; vertical-align: middle;">상품평</td>
									<td width="70"
										style="text-align: center; vertical-align: middle;">예약취소</td>
								</tr>
								<tr>
								</tr>
								...
								<c:if test="${reserveList ne ''}">
									<c:forEach var="productList" items="${productList }"
										...
										<tr>
											<td style="padding: 10px; height: 3px;"><a
												href="/TravelAgency/detailView.do?seq=${productList.pack_no }"
												id="title"> ${productList.pack_title } </a></td>
											<!-- 상품명 pack_no로 가져오기 -->
											<td align="center" style="vertical-align: middle;">${productList.pack_depart }~<br>${productList.pack_arriv }</td>
											<!-- 출발일 귀국일 pack_no로 가져오기 -->
											<c:forEach var="reserveList" begin="${varStatus.index}"
												end="${varStatus.index}" items="${reserveList }">
												...
												<td align="center" style="vertical-align: middle;"><c:if
														test="${reserveList.reviewSEQ eq '0'}">
														<input type="button" value="여행후기작성" id="reviewWrite"
															onclick="javascript:reviewWriteForm(${reserveList.pack_no},'${productList.pack_arriv}')"
															style="cursor: pointer;" />
													</c:if> <c:if test="${reserveList.reviewSEQ ne '0'}">
														<input type="button" value="후기작성완료" disabled />
													</c:if></td>
												<td align="center" style="vertical-align: middle;"><input
													type="hidden" value="${productList.pack_depart }"
													id="depart_date${varStatus.index }" /> <input type="hidden"
													value="${reserveList.list_SEQ }"
													id="cancel_seq${varStatus.index }" /> <input type="hidden"
													value="${reserveList.reviewSEQ }"
													id="review_seq${varStatus.index }" /> <input type="button"
													value="취소" class="reserveCancel" style="cursor: pointer;" />
												</td>
											</c:forEach>
										</tr>
									</c:forEach>
							...
							<div id="paging" style="text-align: center;">
								${ReserveListPaging.pagingHTML }</div>
						</div>
					</div>
				</div>
			</div>
