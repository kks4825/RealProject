        ...
        <div id="package_uploadDIV">
            <form name="package_upload_Form" method="post" enctype="multipart/form-data" action="/TravelAgency/package_upload.do">
                <table id="package_list_table" border="1.2px" cellspacing="0">
                    <tr>
                        <th>패키지명</th>
                        <td><input type="text" class="pack_up_list" name="pack_title"><input type="file" name="img" size="40">
                    	</td>
                    </tr>
                    <tr>
                        <th>패키지금액</th>
                        <td>
                        <input type="number" class="pack_up_list" name="pack_price_kid" placeholder="아동">
                        <input type="number" class="pack_up_list" name="pack_price_adult" placeholder="성인">
                        </td>
                    </tr>
                    <tr>
                        <th>패키지설명</th>
                    ...
                    <tr>
                        <th>여행기간</th>
                        <td>
                            <input type="text" name="pack_depart" size="15" id="date_depart"/>~
                            <input type="text" name="pack_arriv" size="15" id="date_arriv" />
                        </td>
                    </tr>
                    <tr>
                        <th>항공사</th>
                    ...
                    <tr>
                        <th>일정표<input type="button" value="일정추가" id="sche_add" ></th> <!-- onclick="javascript:appendItem()" -->
                    </tr>
                    
                </table>
                <ol id="schedules" ></ol>                
                <input type="button" value="등록" id="upload_check" > <!-- onclick="javascript:upload_check()" -->
            </form>
        </div>
    </body>