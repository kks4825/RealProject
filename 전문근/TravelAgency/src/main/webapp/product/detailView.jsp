...
<div id="all">
	...
	<form name="detailViewForm" method="post" action="/TravelAgency/payment.do">
		...
		<div id="deco">
			<br>
			<img src="image/product/product.jpg" style="width: 80px; height: 20px;">
		</div>
		<div id="productInfo">
			<!-- 상품간단정보 -->
			<div id="img">
			...
			<div id="table">
				...
				<table>
					<tr>
						...
						<td>성인:<fmt:formatNumber pattern="#,##0원"
								value="${productDTO.pack_price_adult }" />, 아동:<fmt:formatNumber
								pattern="#,##0원" value="${productDTO.pack_price_kid }" /></td>
					</tr>
					<tr>
...
<div id="detailInfo">
	<div id="tabs">
		...
		<ul class="tabs_item">
			...
			<li class="items"><a href="#" id="tour_ref"><span>여행
						참고사항</span></a></li>
			<li class="items"><a href="#" id="safe_info"><span>해외여행
						안전정보</span></a></li>
		</ul>
	</div>
	<div id="content1" class="tab_content">
		<table class="table table-striped">
			<c:forEach var="scheduleList" items="${scheduleList }">
				<tr>
					<td width="100px">${scheduleList.schedules_no }일차</td>
					<td>${scheduleList.schedules_content }</td>
				</tr>
			</c:forEach>
		</table>
	</div>
	<div id="content2" class="tab_content">
		${productDTO.pack_detail }<br> <img
			src="product_img/${productDTO.image2 }"
			style="width: 400px; height: 250px;"> <img
			src="product_img/${productDTO.image3 }"
			style="width: 400px; height: 250px;"><br> <img
			src="product_img/${productDTO.image4 }"
			style="width: 400px; height: 250px;"> <img
			src="product_img/${productDTO.image5 }"
			style="width: 400px; height: 250px;"><br> <img
			src="product_img/${productDTO.image6 }"
			style="width: 400px; height: 250px;"> <img
			src="product_img/${productDTO.image7 }"
			style="width: 400px; height: 250px;"><br> <img
			src="product_img/${productDTO.image8 }"
			style="width: 400px; height: 250px;"> <img
			src="product_img/${productDTO.image9 }"
		...
		<c:if test="${reviewList != null }">
			<c:forEach var="TravelReviewDTO" items="${reviewList }">
				<tr>
					...
					<td width="150px" style="text-align: center;"><fmt:formatDate
							value="${TravelReviewDTO.reviewDate}" pattern="yyyy.MM.dd" /></td>
