...
<script type="text/javascript" src="../js/ext-all-3.js"></script>
...
<script type="text/javascript" src="../js/project_ui.js"></script>
...
<div id="lnb" >
	<div class="head_inner">
		<h1 style="width:200px;"><a href="#"><img src="../images/EmperorTour.png" alt="로고"></a></h1>
		<ul class="lnb_nav">
		...
		<ul class="drop_list">
			...
			<li style="width:206px;">
				<ul class="drop_child">
					...
					<li><a href="/customer/event_01">이벤트</a></li>
				</ul>
			</li>
			<li>
				<ul class="drop_child">
					<li><a href="/inq/qa_list">질문과답변</a></li>
					<li><a href="/inq/counseling">1:1문의</a></li>
				</ul>
			</li>
		</ul>
	</div>
		...
		<div class="main_banner">
			<div id="main_banner_slide">
				<h2 class="blind">메인 슬라이드 배너</h2>
						<ul id="mainSlideBnr">
							<li><a href="/about/about"><img src="../images/TravelAgency3.png" /></a></li>
							<li><a href="/about/about"><img src="../images/TravelAgency.png" /></a></li>
							<li><a href="/about/about"><img src="../images/TravelAgency4.png" /></a></li>					
						</ul>
			...
			<ul id="subBnrWrap">
				<li><a href="/about/history"><img src="../images/main_sub_bnr_01.png" alt="회사연혁"></a></li>
				<li><a href="/about/about"><img src="../images/main_sub_bnr_02.png" alt="기업이념"></a></li>
				<li><a href="/business/business1"><img src="../images/main_sub_bnr_03.png" alt="서비스소개"></a></li>
				<li><a href="/about/location"><img src="../images/main_sub_bnr_04.png" alt="오시는길"></a></li>
			</ul>
		</div><!--main_banner-->
		<div id="asideBnrWrap">
				<img src="../images/TravelAgency1.png" alt="WE ARE ANEX" title="고객의 안전한 여행을 책임지는 황제투어 입니다. 저희는 늘 고객의 입장에서 바라볼 수 있도록 노력합니다.보다 쉽고 편하고 안전한 여행을 원하신다면 저희 황제투어와 함께 하세요" />
		</div>
...
Ext.onReady(function(){
    choice.list('event');
		...
		<div id="mainArticle">
			<div id="articleWrap">
				<div id="search">
					<h2><img src="../images/EmperorTour2.png" style="width:250px; height:50px;" alt="로고" /></h2>
