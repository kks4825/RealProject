...
<script type="text/javascript">
	...
	function checkEmail() {
		...
		if (sEmail == "") {
			...
			window.open("/TravelAgency/emailChk.do?memEmail=" + sEmail, "",
					"width=320 height=100");
		}
	}
</script>
						...
						<table class="board_css">
							...
							<tr>
								...
								<td><input type="password" name="memPwd" id="memPwd"
									allowblank=false label='비밀번호' class='' style=''/ > <span
									class="guide">비밀번호는 대소문자 구분하여 영문+숫자 6~16자로 입력하세요.</span></td>
							</tr>
							<tr>
								<th>비밀번호 확인</th>
							...
							<tr>
								<th>우편번호</th>
								<td><input type="text" name="memZipCode" id="zip" size="7"
							...
							<tr>
								<th>주소</th>
								<td><input type="text" name="memAddr1" id="address1"
									size="50" readonly><br> <input type="text"
									name="memAddr2" id="address2" size="50"><br> <label
									for="memAddr2" class="error"></label></td>
							</tr>
							<tr>
								<th>전화번호</th>
