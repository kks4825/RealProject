...
<script type="text/javascript">
	function isLogin(seq){
		if('${memId}'=='')
			...
			location.href="/TravelAgency/boardQnaView.do?seq="+seq+"&pg=${pg}";
	}
	...
	function boardSearchPaging(pg){
		location.href="/TravelAgency/board/boardQnaSearch.do?pg="+pg
		...
		<div class="sub_container">
			...
			<form name="boardListForm">
					<table class="board_list">
						<thead>
						<tr>
							<th width="10%"><input name="allcheck" type="checkbox" onclick="allCheck()">번호</th>
							<th width="10%">분류</th>
							<th width="45%">제목</th>
							<th width="#">이름</th>
							<th width="#">날짜</th>
